...
<script type="text/javascript">
	function answerWindow(num){
		window.open('answer.bit?num='+num,'상담답변','width=500,height=400');
	}
	function editWindow(num,answer){
		window.open('edit.bit?num='+num+'&answer='+answer,'상담수정','width=500,height=400');
	}
	
	function deleteAlert(num){
		window.open('delete.bit?num='+num,'상담수정','width=500,height=400');
	}
</script>
</head>
<body>
