	...
	<nav id="nav">
		<ul id="menu">
			...
			<li id="mymenu" class="topmenu"><a href="#" class="topmenuLink">내 메뉴</a>
				<ul class="submenu">
					<li><a href="#" class="submenuLink">강의개설</a></li>
					<li><a href="#" class="submenuLink">학생배정</a></li>
					<li><a href="#" class="submenuLink">출결확인</a></li>
		...
		<div id="login">
		    <div class="temp1">
		        <span>
		            <img src="${rootPath}img/login/executive.png" class="identity"><a href="#" class="in">XXX 님(행정)</a>
		        </span>
		    </div>
		    <div class="temp2">
