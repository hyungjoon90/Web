	...
	<nav id="nav">
		<ul id="menu">
			...
			<li id="mymenu" class="topmenu"><a href="#" class="topmenuLink">내 메뉴</a>
				<ul class="submenu">
					<li><a href="#" class="submenuLink">성적관리</a></li>
					<li><a href="#" class="submenuLink">출결관리</a></li>
					<li><a href="#" class="submenuLink longlink">강의 공지사항</a></li>
					<li><a href="#" class="submenuLink longlink">직원 공지사항</a></li>
				</ul>
			</li>
		</ul>
		<!--로그인 시작-->
		<div id="login">
		    <div class="temp1">
		        <span>
		            <img src="${rootPath}img/login/teacher.png" class="identity"><a href="#" class="in">XXX 님(강사)</a>
		        </span>
		    </div>
		    <div class="temp2">
