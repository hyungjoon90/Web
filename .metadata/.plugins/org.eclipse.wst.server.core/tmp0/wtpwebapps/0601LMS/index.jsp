...
<body>
	...
	<article id="article">
		<div id="container">
		   	...
		   	<div class="topImg">
			 	<div class="maincard">
			 		<a href="#"><img alt="" src="img/main/lecture_main.png" class="mainimg lecture"></a>
			 	</div>
			 	<div class="maincard">
			 		<a href="#"><img alt="" src="img/main/consulting_main.png" class="mainimg consulting"></a>	 	
			 	</div>
			 	<div class="maincard">
			 		<a href="#"><img alt="" src="img/main/jobafter_main.png" class="mainimg jobafter"></a>	 	
			 	</div>
		 	</div>
		</div>
</article>
