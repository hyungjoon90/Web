		...
		<div id="container">
				...
				<div id="table">
					<div class="row">
						...
						<span class="cell top col3">글쓴이(ID)</span>
						<span class="cell top col4">작성일</span>
						<span class="cell top col5">조회수</span>
					</div>
					<c:forEach items="${requestScope.alist }" var="dtoLecAf">
					<div class="row">
						<span  class="cell col1">${dtoLecAf.rn }</span>
						<span  class="cell col2"><a href="?mode=detail&idx=${dtoLecAf.num}" class="act">${dtoLecAf.title }</a></span>
						<span  class="cell col3">${dtoLecAf.id }</span>
						<span  class="cell col4">${dtoLecAf.nalja }</span>
						<span  class="cell col5">${dtoLecAf.viewNum }</span>
					</div>
					</c:forEach>
				</div>
				<div class="btn">
					<button class="button">글씨기</button>
				</div>
				<div class="clear">
				</div>
			</div>
