		...
		<div id="container">
		 	...
		 	<form method="post" class="innerCon">
				...
				<div class="purpose row">
					<label for="purpose" class="subject" class="input">수강목적</label>
					<input type="radio" name="purpose" id="purpose" value="job"> 취업특강
					<input type="radio" name="purpose" id="purpose" value="vacation"> 방학특강
				</div>
				<div class="phone row">
					<label for="phone" class="subject">휴대폰</label>
					<input type="text" name="phone" id="phone" value=" - 없이 입력해주세요." class="input">
				</div>
