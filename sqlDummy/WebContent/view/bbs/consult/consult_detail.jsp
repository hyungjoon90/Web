...
<script type="text/javascript">
	function answerWindow(num){
		window.open('?mode=answer&num='+num,'상담답변','width=500,height=400');
	}
	function editWindow(num,answer){
		window.open('?mode=edit&num='+num+'&answer='+answer,'상담수정','width=500,height=400');
	}
	
	function deleteAlert(num){
		window.open('?mode=del&num='+num,'상담수정','width=200,height=100');
	}
</script>
</head>
<body>
