select * from JOB_AF_BBS;

select JOB_AF_BBS.num,JOB_AF_BBS.company,lec_info.class_name,JOB_AF_BBS.title,JOB_AF_BBS.name,JOB_AF_BBS.field,JOB_AF_BBS.contents from JOB_AF_BBS,lec_info where JOB_AF_BBS.lec_code=lec_info.lec_code and num=28;

SELECT A.NUM,A.COMPANY,B.CLASS_NAME,A.TITLE,A.NAME,A.FIELD,A.CONTENTS FROM JOB_AF_BBS A,LEC_INFO B WHERE A.LEC_CODE=B.LEC_CODE AND NUM=28
...
insert into LEC_INFO values (1111,'테스트명1','아무개',sysdate,sysdate,20,'java','http://asd.com','임시내용1',2,101);
