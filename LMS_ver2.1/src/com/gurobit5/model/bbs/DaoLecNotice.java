...
public class DaoLecNotice {
	...
	public ArrayList<DtoLecNotice> selectAll() throws ClassNotFoundException, SQLException{
		String sql="select rownum as rn, A.num, A.title, A.id, A.nalja, A.view_num from "
				+ "(select num, title, id, nalja, view_num from lec_notice_bbs order by num) A order by rn desc";
