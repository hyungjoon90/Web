...
insert into LEC_INFO values (LEC_CODE_SEQ.nextval,'테스트명2','아무개2',sysdate,sysdate,20,'web','http://asd.com','임시내용2',2,102);
insert into LEC_INFO values (LEC_CODE_SEQ.nextval,'테스트명3','아무개3',sysdate,sysdate,20,'db','http://asd.com','임시내용3',2,103);
insert into LEC_INFO values (LEC_CODE_SEQ.nextval,'테스트명4','아무개4',sysdate,sysdate,20,'java','http://asd.com','임시내용4',2,104);
insert into LEC_INFO values (LEC_CODE_SEQ.nextval,'테스트명5','아무개5',sysdate,sysdate,20,'java','http://asd.com','임시내용5',2,101);
insert into LEC_INFO values (LEC_CODE_SEQ.nextval,'테스트명6','아무개6',sysdate,sysdate,20,'web','http://asd.com','임시내용6',2,102);
insert into LEC_INFO values (LEC_CODE_SEQ.nextval,'테스트명7','아무개7',sysdate,sysdate,20,'db','http://asd.com','임시내용7',2,103);
insert into LEC_INFO values (LEC_CODE_SEQ.nextval,'테스트명8','아무개8',sysdate,sysdate,20,'java','http://asd.com','임시내용8',2,104);
...
insert into MEMBER values ('임시id', '1234', '강사1', 123456, 'tea00@naver.com', 1, 18000);
insert into MEMBER values ('tea01', '1234', '강사2', 123456, 'tea01@naver.com', 1, 18001);

insert into MEMBER values ('admin', '1234', '관리자', 123456, 'admin@naver.com', 5, null);
...
insert into Lec_af_bbs values (LEC_AF_BBS_SEQ.nextval,'수강후기5','khj',sysdate,18001,'가나다라마바사아자차카타',0);
insert into Lec_af_bbs values (LEC_AF_BBS_SEQ.nextval,'수강후기6','khj',sysdate,18001,'가나다라마바사아자차카타',0);
insert into Lec_af_bbs values (LEC_AF_BBS_SEQ.nextval,'수강후기7','khj',sysdate,18001,'가나다라마바사아자차카타',0);
