	...
	<article id="article">
		<div id="container">
				...
				<form method="post" class="innerCon">
					...
					<div  class="btn">
						<button onclick="movelist()" class="button">목록</button>
						<button onclick="edit(${dtoEmpNotice.num})" class="button">수정</button>
						<button onclick="deleteon(${dtoEmpNotice.num})"  class="button">삭제</button>
					</div>
				</form>
				<div class="clear">
				</div>
