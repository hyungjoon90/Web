	...
	<nav id="nav">
		<ul id="menu">
			...
			<li id="mymenu" class="topmenu"><a href="#" class="topmenuLink">내 메뉴</a>
				<ul class="submenu">
					<li><a href="#" class="submenuLink">출석확인</a></li>
					<li><a href="#" class="submenuLink">성적확인</a></li>
		...
		<div id="login">
		    <div class="temp1">
		        <span>
		            <img src="${rootPath}img/login/student.png" class="identity"><a href="#" class="in">XXX 님(학생)</a>
		        </span>
		    </div>
		    <div class="temp2">
