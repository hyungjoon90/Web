...
/*LEC_INFO 강의DB (강의상태는 1: 비공개0 2: 공개 3: 진행중 4: 완료)*/
...
/*MEMBER 계정DB 학생 : 0, 교사 : 1, 취업 : 2, 영업 : 3, 행정 : 4, 관리자 : 5, 임시 : 99 */
truncate table MEMBER;
insert into MEMBER values ('stu01', '1234', '학생1', 123456, 'stu01@naver.com', 0, 18000);
insert into MEMBER values ('stu02', '1234', '학생2', 123456, 'stu02@naver.com', 0, 18001);
...
insert into MEMBER values ('tea01', '1234', '강사2', 123456, 'tea01@naver.com', 1, 11111);
insert into MEMBER values ('tea02', '1234', '강사3', 123456, 'tea01@naver.com', 1, 11111);
insert into MEMBER values ('tea03', '1234', '강사4', 123456, 'tea00@naver.com', 1, 11111);
