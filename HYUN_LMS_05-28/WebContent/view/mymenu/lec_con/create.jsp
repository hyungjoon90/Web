...
<body>
	<div class ="con ">
		...
		<div class="column2_1">
			...
			<input id="className" name="className" type="text" class="val"/>
			<br/>
		...
		<div class="column_2_1">
			<label for="openDate" class="lab">개강일</label><input id="openDate" type="date" name="openDate" class="val" /> 
			<br/>
			<label for="endDate" class="lab">종강일</label><input id="endDate" type="date" name="endDate" class="val"/>
			<br/>
