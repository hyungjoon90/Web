...
<body>
	...
	<br>
	<hr class="bar"/>
		<span class="navigator"> 홈 > 학원소개 > 교수진소개</span>
	<hr class="bar"/>
	<!--탭 네비게이션 끝-->
	<!--내용시작-->
	<article id="article">
		...
		<div id="container">
			<div>
				<img alt="teacher1" src="../img/intro/teacher1.png">
			</div>
			<div>
				<img alt="teacher2" src="../img/intro/teacher2.png">
			</div>
			<div>
				<img alt="teacher3" src="../img/intro/teacher3.png">
			</div>
		</div>
    </article>
    <!--내용끝-->
